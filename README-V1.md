...
**Note: this readme is only valid for version 1 of the library! Check the current README.md for updated API documentation and GitHub's releases for migration guide.**
